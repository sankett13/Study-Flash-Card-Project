            ...
            return (
              ...
              >
                ...
                <div className="flex items-start gap-4 md:justify-end">
                  <div className="shrink-0 w-12 h-12 rounded-full bg-pink-600 flex items-center justify-center">
                ...
                <div className="hidden md:block absolute left-1/2 -translate-x-1/2">
                  <div className="w-px h-16 bg-pink-300"></div>
                  <div className="w-3 h-3 rounded-full bg-pink-600 -ml-1"></div>
                  <div className="w-px h-16 bg-pink-300"></div>
                </div>
